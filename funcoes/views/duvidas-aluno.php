                                ...
                                <div class="calltoaction_form mb-0">
                                    <form id="form_create_pergunta">
                                        ...
                                        <div class="form_item">
                                            ...
                                            <input id="iCdProfessor" name="nCdProfessor" type="hidden" value="<?php echo $voResultadoTotal->CD_PROFESSOR ?>">
                                            ...
                                            <li>
                                                ...
                                                ?>
                                                    <div class="<?php echo "comment_item collapsed " . $voResultadoDuvidas->ST_DUVIDA_CLASS ?>">
                                                        ...
                                                        <?php } ?>
                                                        <div class="reply_btn like_btn cursor-pointer" data-duvida="<?php echo $voResultadoDuvidas->CD_DUVIDA ?>"><i class="far fa-thumbs-up"></i> <?php echo $voResultadoDuvidas->NR_CURTIDAS ?></div>
                                                            ...
                                                            ?>
                                                                <li>
                                                                    <div class="comment_item comentario">
                                                                        ...
                                                                        <?php if ($voResultadoComentarios->IMAGEM !== NULL) { ?>
                                        ...
                                        <li>
                                            ...
                                            ?>
                                                <div class="<?php echo "comment_item collapsed " . $voResultadoDuvidasDestacadas->ST_DUVIDA_CLASS ?>">
                                                    ...
                                                    <div class="reply_btn like_btn cursor-pointer" data-duvida="<?php echo $voResultadoDuvidasDestacadas->CD_DUVIDA ?>"><i class="far fa-thumbs-up"></i> <?php echo $voResultadoDuvidasDestacadas->NR_CURTIDAS ?></div>
