                    ...
                    <div class="content_wrapper">
                        <div class="row align-items-center">
                            <ul class="breadcrumb_nav unordered_list">
                                <li><a href="<?php echo URL . "periodosProfessor" ?>"><i class="far fa-reply"></i> Voltar à página de períodos</a></li>
                            </ul>
                        ...
                        ?>
                            <div class="col col-lg-4">
                                <div class="event_card">
                                    <a class="item_image" href="<?php echo URL . "duvidasProfessor?curso=" . $voResultadoDisciplinasProfessor->CD_CURSO . "&periodo=" . $voResultadoDisciplinasProfessor->NR_PERIODO . "&disciplina=" . $voResultadoDisciplinasProfessor->CD_DISCIPLINA ?>">
                                    ...
                                    <div class="item_content">
                                        <h3 class="item_title">
                                            <a href="<?php echo URL . "duvidasProfessor?curso=" . $voResultadoDisciplinasProfessor->CD_CURSO . "&periodo=" . $voResultadoDisciplinasProfessor->NR_PERIODO . "&disciplina=" . $voResultadoDisciplinasProfessor->CD_DISCIPLINA ?>">
                                                <?php echo $voResultadoDisciplinasProfessor->DS_DISCIPLINA ?>
                                            </a>
                                        </h3>
                                        <ul class="header_btns_group unordered_list">
                                            <li><a href="<?php echo URL . "duvidasProfessor?curso=" . $voResultadoDisciplinasProfessor->CD_CURSO . "&periodo=" . $voResultadoDisciplinasProfessor->NR_PERIODO . "&disciplina=" . $voResultadoDisciplinasProfessor->CD_DISCIPLINA ?>" class="btn btn_dark"><span><small>Acessar disciplina</small> <small>Acessar disciplina</small></span></a></li>
