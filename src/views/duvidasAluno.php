...
<body>
                    ...
                    <div class="content_wrapper">
                        <div class="row align-items-center">
                            <ul class="breadcrumb_nav unordered_list2">
                                <li><a href="<?php echo URL . "disciplinasAluno" ?>"><i class="far fa-reply"></i> Voltar à página de disciplinas</a></li>
                            </ul>
                            <?php
    ...
    <script src="<?php echo URL . "src/scripts/comentario.min.js" ?>"></script>
    <script src="<?php echo URL . "src/scripts/pergunta.min.js" ?>"></script>
    <script>
