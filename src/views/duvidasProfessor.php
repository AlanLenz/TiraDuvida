...
if (isset($_SESSION['usuario_id']) && isset($_SESSION['usuario_login']) && ($_SESSION['tipo_usuario'] == "P")) {
    ...
    $url_pagina = "duvidasProfessor?" . $filtro_status . $filtro_curso . $filtro_periodo . $filtro_disciplina;
} else {
...
<body>
                            ...
                            <div class="dropdown">
                                <li>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-custom" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo URL . "disciplinasProfessor?curso=" . $_GET['curso'] . "&periodo=" . $_GET['periodo'] ?>">Disciplinas</a></li>
                    ...
                    <div class="content_wrapper">
                        <div class="row align-items-center">
                            <ul class="breadcrumb_nav unordered_list2">
                                <li><a href="<?php echo URL . "disciplinasProfessor?curso=" . $_GET['curso'] . "&periodo=" . $_GET['periodo'] ?>"><i class="far fa-reply"></i> Voltar à página de disciplinas</a></li>
                                                ...
                                                ?>
                                                    <div class="<?php echo "comment_item collapsed " . $voResultadoDuvidas->ST_DUVIDA_CLASS ?>">
                                                        ...
                                                        <?php if (!empty($voResultadoPergunta->IMAGEM)) { ?>
                                                            <img src="<?php echo URL . "src/uploads/perguntas/" . $voResultadoPergunta->IMAGEM ?>" title="<?php echo $voResultadoDuvidas->DS_TITULO ?>" alt="<?php echo "Imagem " . $voResultadoDuvidas->DS_TITULO ?>">
                                                        <?php }
                                                                ...
                                                                <li>
                                                                    <div class="comment_item resposta">
                                                                        ...
                                                                        <?php if (!empty($voResultadoResposta->IMAGEM)) { ?>
                                                                            <img src="<?php echo URL . "src/uploads/respostas/" . $voResultadoResposta->IMAGEM ?>" title="<?php echo $voResultadoDuvidas->DS_TITULO ?>" alt="<?php echo "Imagem " . $voResultadoDuvidas->DS_TITULO ?>">
                                                                        <?php } ?>
                                                                    </div>
                                                                </li>
                                                            <?php
                                                                ...
                                                                <li>
                                                                    <div class="comment_item comentario">
                                                                        ...
                                                                        <?php if (!empty($voResultadoComentarios->IMAGEM)) { ?>
                                                                            <img src="<?php echo URL . "src/uploads/perguntas/" . $voResultadoComentarios->IMAGEM ?>" title="<?php echo $voResultadoDuvidas->DS_TITULO ?>" alt="<?php echo "Imagem " . $voResultadoDuvidas->DS_TITULO ?>">
                                                                        <?php } ?>
                                            ...
                                            ?>
                                                <div class="<?php echo "comment_item collapsed " . $voResultadoDuvidasDestacadas->ST_DUVIDA_CLASS ?>">
                                                    ...
                                                    <?php if (!empty($voResultadoPerguntaDestacada->IMAGEM)) { ?>
                                                        <img src="<?php echo URL . "src/uploads/perguntas/" . $voResultadoPerguntaDestacada->IMAGEM ?>" title="<?php echo $voResultadoDuvidasDestacadas->DS_TITULO ?>" alt="<?php echo "Imagem " . $voResultadoDuvidasDestacadas->DS_TITULO ?>">
                                                    <?php } ?>
                                                        ...
                                                        <li>
                                                            <div class="comment_item resposta">
                                                                ...
                                                                <?php if (!empty($voResultadoRespostaDestacada->IMAGEM)) { ?>
                                                                    <img src="<?php echo URL . "src/uploads/respostas/" . $voResultadoRespostaDestacada->IMAGEM ?>" title="<?php echo $voResultadoDuvidasDestacadas->DS_TITULO ?>" alt="<?php echo "Imagem " . $voResultadoDuvidasDestacadas->DS_TITULO ?>">
                                                                <?php } ?>
                                                        ...
                                                        <li>
                                                            <div class="comment_item comentario">
                                                                ...
                                                                <?php if (!empty($voResultadoComentariosDestacados->IMAGEM)) { ?>
                                                                    <img src="<?php echo URL . "src/uploads/perguntas/" . $voResultadoComentariosDestacados->IMAGEM ?>" title="<?php echo $voResultadoDuvidasDestacadas->DS_TITULO ?>" alt="<?php echo "Imagem " . $voResultadoDuvidasDestacadas->DS_TITULO ?>">
                                                                <?php } ?>
                                                                <div class="reply_btn">COMENTÁRIO</div>
                                                            </div>
                                                        </li>
    ...
    <script src="<?php echo URL . "src/scripts/duvida.min.js" ?>"></script>
    <script src="<?php echo URL . "src/scripts/resposta.min.js" ?>"></script>
    <script src="<?php echo URL . "src/js/modalAluno.min.js" ?>"></script>
    <script>
